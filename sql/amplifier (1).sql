...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 06, 2019 at 07:26 AM
...
CREATE TABLE `users` (
  ...
  `offense` set('1','2','3','') COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` (`user_id`, `user_type`, `username`, `password`, `status`, `name`, `email`, `email_verified_date`, `address`, `rate`, `photo`, `telephone_1`, `telephone_2`, `date_registered`, `offense`, `report_count`, `media_fk`) VALUES
(1, 'client', 'user1', 'pass', 'verified', 'client', 'email@gmail.com', '2019-10-09', 'cebu', '1200.00', 'assets/img/1.jpg', '09123331', '09123123123', '2019-10-10', '2', 0, NULL),
(2, 'performer', 'user2', 'pas', 'pending', 'perforemr', 'email2@gmail.com', NULL, 'talamban', '12333.00', 'assets/img/1.jpg', '09123331', '0912333', '2019-10-22', '3', 1, NULL),
(3, '', 'bad', 'bad', 'block', 'bad', 'bad', '2019-10-06', 'baduser', '1200.00', 'assets/img/1.jpg', '1231231', '12313123', '2019-10-24', '3', 100, NULL);
