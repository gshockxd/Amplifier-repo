            ...
            function addInput()
            {
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    class="form-control <?php echo form_error('event_name') ? 'is-invalid' : '' ?>"
                                    name="event_name" value="<?php echo isset($event_name) ? $event_name : '' ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="event_date"
                                            class="form-control <?php echo form_error('event_date') ? 'is-invalid' : '' ?>"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control text-capitalize" disabled
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time" name="duration"
                                            class="form-control <?php echo form_error('duration') ? 'is-invalid' : '' ?>"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time" name="event_time"
                                            class="form-control <?php echo form_error('event_time') ? 'is-invalid' : '' ?>"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="down_payment"
                                    class="form-control <?php echo form_error('down_payment') ? 'is-invalid' : '' ?>"
                                    value="<?php echo isset($down_payment) ? $down_payment : '' ?>">
                                <div class="invalid-feedback">
                                    <?php echo form_error('down_payment') ?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text"
                                    class="form-control <?php echo form_error('location') ? 'is-invalid' : '' ?>"
                                    name="location" value="<?php echo isset($localtion) ? $location : '' ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="notes" id="ckeditor"
                                    class="form-control <?php echo form_error('notes') ? 'is-invalid' : '' ?>"><?php echo isset($notes) ? $notes : '' ?></textarea>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header bg-primary text-capitalize text-white">
                                    <?php echo $package['package_name'] ?></div>
