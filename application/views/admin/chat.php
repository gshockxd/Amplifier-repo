            ...
            <div id="content">
                ...
                <div class="container py-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <p class="h5 font-weight-bold red-brown d-flex justify-content-center">
                                <?php echo $this->session->userdata('fname') ?>
                                <?php echo $this->session->userdata('lname') ?></p>
                            <hr class="">
                            <!-- {{-- Incoming Msg --}} -->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="inbox-chat">
                                ...
                                <div id="chat-2">
                                    <a href="<?php echo base_url(); echo 'a_chat/'; echo $c['user_id']?>"
                                        class="btn btn-outline-chat col-md-12">
                                        <div class="row text-chat">
                                            <!--  {{-- lvl 1.2 --}} -->
                                            <div class="col-md-2">
                                                <!-- {{-- lvl 1.2.1 --}} -->
                                                <img src="<?php echo base_url(); echo $c['photo'] ?>" alt=""
                                            ...
                                            <div class="col-md-10 ">
                                                ...
                                                <div class="row ">
                                                    <div class="col-md-8 ">
                                                        <p class="text-capitalize"><?php echo $c['fname'] ?>
                                                            <?php echo $c['lname'] ?></p>
                                                    </div>
                                                    <div class="col-md-4">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <!--  {{-- lvl 1.2.2.1 --}} -->
                                                        <p class="d-flex justify-content-start ml-4">
                                                            <?php echo $c[0]['outgoing_id'] == $this->session->userdata('user_id') ? 'You: '.$c[0]['message'] : $c[0]['message']  ?>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-md-8">
                            <p class="h5 font-weight-bold red-brown d-flex justify-content-center">
                                <?php echo $user_info['fname'] ?> <?php echo $user_info['lname'] ?></p>
                            <hr class="">
                            <!-- {{-- Incoming Msg --}} -->
                            <div class="inbox-convo">
                                ...
                                <div class="row">
                                    <div class="col-md-1">
                                        <img src="<?php echo base_url(); echo $user_info['photo']?>"
                                            class="msg-img rounded-circle" alt="">
                                    </div>
                                    <div class="col-md-6">
                                        <p class="inbox-padding inbox-bg-incoming float-left">
                                            <?php echo $ch['message'] ?> </p>
                                        <p class="text-muted msg-time clear-left">
                                            <?php echo date('h:i a m/d/y', strtotime($ch['c_created_at'])) ?></p>
                                    </div>
                                    <div class="col-md-4 ">
                                        <!-- {{-- 2.3 --}} -->
                                    </div>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-6 ">
                                        <p class="float-right inbox-padding inbox-bg-yellow-brown text-white">
                                            <?php echo $ch['message'] ?></p>
                                        <p class="d-flex msg-time text-muted justify-content-end clear-right">
                                            <?php echo date('h:i a m/d/y', strtotime($ch['c_created_at'])); ?> </p>
                                    </div>
                                    <div class="col-md-1">
                                        <img src="<?php echo base_url(); echo $this->session->userdata('photo') ?>"
                                            class="msg-img rounded-circle align-items-center" alt="">
                                    </div>
                                </div>
                                <?php endif; ?>
                                <!-- {{-- end of outgoing msg --}} -->
                            ...
                            <div class="row pr-3">
                                <div class="col-md-11 ">
                                    <input type="text" name="message"
                                        class="form-group form-control <?php echo form_error('message') ? 'is-invalid' : '' ?>"
                                        placeholder="<?php echo form_error('message') ? form_error('message') : 'Type a message...' ?>">
                                </div>
                                <div class="col-md-1 ">
                                    <button type="submit" name="send_message" value="send_message"
                                        class="unstyled-button red-brown"><i
                                            class="far fa-paper-plane fa-2x"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
